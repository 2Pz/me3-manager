...
class GameManagementDialog(QDialog):
    ...
    def __init__(self, config_manager, parent=None):
        ...
        self.setWindowTitle(tr("manage_games"))
    ...
    def init_ui(self):
        ...
        self.add_button = QPushButton(tr("add_game"))
        self.add_button.setObjectName("AddButton")
        self.add_button.clicked.connect(self.add_game)
        buttons_layout.addWidget(self.add_button)

        self.remove_button = QPushButton(tr("remove_game"))
        self.remove_button.setObjectName("RemoveButton")
        self.remove_button.clicked.connect(self.remove_game)
        buttons_layout.addWidget(self.remove_button)

        self.restore_button = QPushButton(tr("restore_default"))
...
class AddGameDialog(QDialog):
    ...
    def init_ui(self):
        ...
        form_layout.addRow(tr("game_name_form"), self.name_input)

        name_example = QLabel(tr("game_name_example_label"))
        ...
        form_layout.addRow(tr("game_mods_form"), self.mods_dir_input)

        mods_example = QLabel(tr("game_mods_example_label"))
        ...
        form_layout.addRow(tr("game_profile_form"), self.profile_input)

        profile_example = QLabel(tr("game_profile_example_label"))
        ...
        form_layout.addRow(tr("game_cli_form"), self.cli_id_input)

        cli_example = QLabel(tr("game_cli_example_label"))
        ...
        form_layout.addRow(tr("game_exe_form"), self.executable_input)

        exe_example = QLabel(tr("game_exe_example_label"))
        ...
        add_button = QPushButton(tr("add_game"))
    ...
    def add_game(self):
        ...
        if not all([name, mods_dir, profile, cli_id, executable]):
            QMessageBox.warning(self, tr("validation_error"), tr("all_fields_required"))
            return
        ...
        try:
            ...
            QMessageBox.critical(self, tr("ERROR"), tr("add_new_game_failed", e=str(e)))
