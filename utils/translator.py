...
class Translator:
    ...
    def set_language(self, language_code: str):
        ...
        if language_code in self.translations:
            ...
            print(f"Warning: Translation for language '{language_code}' not found. Using English.")
            self.current_language = 'en'
    ...
    def set_system_language(self):
        ...
        if language_code in self.translations:
            ...
            if system_locale in self.translations:
                ...
                print(f"System language '{system_locale}' not supported. Using English.")
                self.current_language = 'en'
    ...
    def tr(self, key: str, **kwargs) -> str:
        ...
        if kwargs:
            try:
                ...
                print(f"Error formatting translation for key '{key}': missing argument {e}")
