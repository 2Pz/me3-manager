...
class UiBuilder:
    ...
    def _create_banner_container(self):
        """Create a centralized layout for dynamically showing various banners."""
        self.game_page.banner_container_layout = QVBoxLayout()
        self.game_page.banner_container_layout.setSpacing(8)
        self.game_page.banner_container_layout.setContentsMargins(0, 0, 0, 8)
        self.game_page.main_layout.addLayout(self.game_page.banner_container_layout)
